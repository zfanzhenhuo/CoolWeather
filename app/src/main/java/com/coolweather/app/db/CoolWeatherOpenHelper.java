...
public class CoolWeatherOpenHelper extends SQLiteOpenHelper {
     ...
     * City表建表语句
     */
    public static final String CREATE_CICY = "create table City(id integer primary key autoincrement,city_name text,city_code text,province_id integer)";
